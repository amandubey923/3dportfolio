    ...
    >
      ...
      <div className="w-full min-w-0">
        <div className="relative h-44 xs:h-48 sm:h-52 lg:h-56 w-full overflow-hidden border-b border-white/10 bg-black/40">
          ...
          <div className="absolute top-2.5 sm:top-3.5 left-2.5 sm:left-3.5 flex items-center gap-1.5 sm:gap-2 z-10">
            <span className={`px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full border text-[10px] sm:text-[11px] font-mono font-bold uppercase tracking-wider backdrop-blur-md shadow-md ${theme.tagClass}`}>
              {project.category}
            </span>
            {isFeaturedReaderHub && (
              <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full border border-amber-400/60 bg-slate-950/90 text-amber-300 text-[10px] sm:text-xs font-bold uppercase tracking-wider backdrop-blur-md shadow-[0_0_16px_rgba(245,158,11,0.35)]">
          ...
          <button
            ...
            className="absolute top-2.5 sm:top-3.5 right-2.5 sm:right-3.5 p-1.5 sm:p-2 rounded-xl border border-white/20 bg-black/60 backdrop-blur-md text-white hover:text-primary hover:border-primary transition group-hover:scale-110 shadow-lg z-10"
          >
        ...
        <div className="p-3.5 sm:p-5 lg:p-6 space-y-2 sm:space-y-3 w-full min-w-0">
          ...
          <div className="flex flex-wrap gap-1 sm:gap-1.5 pt-1 sm:pt-2 w-full min-w-0">
            {project.technologies.slice(0, 4).map((tech) => (
              <span
                key={tech}
                className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md sm:rounded-lg border border-foreground/10 bg-foreground/[0.03] text-[10px] sm:text-[11px] font-mono text-foreground font-medium break-words"
              >
                {tech}
              </span>
            ))}
            {project.technologies.length > 4 && (
              <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md sm:rounded-lg border border-primary/30 bg-primary/10 text-[10px] sm:text-[11px] font-mono text-primary font-bold shrink-0">
                +{project.technologies.length - 4}
              </span>
            )}
          </div>
      ...
      <div className="p-3.5 sm:p-5 lg:p-6 pt-0 mt-1 flex flex-wrap items-center justify-between gap-2 border-t border-foreground/10 pt-3 sm:pt-4 w-full min-w-0">
        ...
        {project.liveUrl ? (
          <a
            ...
            className="inline-flex items-center gap-1 sm:gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-primary/15 border border-primary/30 text-[11px] sm:text-xs font-bold text-primary hover:bg-primary hover:text-primary-foreground shadow-[0_0_15px_var(--glow-primary)] transition-all group/link active:scale-95"
          >
            <span>Live Demo</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 sm:gap-1.5 px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-foreground/[0.04] border border-foreground/15 text-[11px] sm:text-xs font-semibold text-foreground hover:border-primary hover:text-primary transition active:scale-95"
          >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <button
            onClick={() => onInspect(project)}
            className="px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl border border-foreground/10 bg-foreground/[0.03] text-[11px] sm:text-xs font-semibold text-foreground hover:border-primary/50 hover:text-primary transition cursor-pointer"
          >
            Details
          </button>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 sm:p-2.5 rounded-lg sm:rounded-xl border border-foreground/10 bg-foreground/[0.03] text-foreground/70 hover:border-primary/50 hover:text-primary hover:shadow-[0_0_15px_var(--glow-primary)] transition"
