...
export default function ProjectsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="ambient-orb ambient-orb-1 w-[320px] sm:w-[450px] h-[320px] sm:h-[450px] top-10 -right-20 animate-orb-pulse" />
      <div className="ambient-orb ambient-orb-3 w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] bottom-1/3 -left-20 animate-orb-pulse" style={{ animationDelay: "3.5s" }} />

      {/* Section Header with Editorial Index */}
      <div className="mb-8 sm:mb-14 space-y-2 sm:space-y-3 relative z-10 w-full min-w-0">
        ...
        <p className="max-w-2xl text-foreground/75 text-sm sm:text-base lg:text-lg leading-relaxed break-words">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 mb-8 sm:mb-12 relative z-10 w-full min-w-0">
        {/* Category Filter Pills */}
        <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto pb-1.5 sm:pb-2 w-full min-w-0 max-w-full no-scrollbar">
          {categories.map((cat) => {
        ...
        <div className="relative w-full sm:w-72 shrink-0">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 sm:py-2.5 rounded-xl border border-foreground/10 bg-card text-xs text-foreground placeholder:text-foreground/50 focus:outline-none focus:border-primary focus:shadow-[0_0_15px_var(--glow-primary)] transition"
          />
        </div>
      </div>

      {/* Projects Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 relative z-10 w-full min-w-0">
      ...
      {isDefaultView && (
        <div className="mt-8 sm:mt-12 text-center relative z-10">
          <button
            ...
            className="btn-secondary-glass inline-flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 rounded-2xl text-xs font-bold text-foreground hover:text-primary transition shadow-md cursor-pointer"
          >
